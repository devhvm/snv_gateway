    ...
    return (
      <div>
        <h2 id="pham-vi-heading">
          <Translate contentKey="gatewayApp.donviphathanhPhamVi.home.title">Pham Vis</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="gatewayApp.donviphathanhPhamVi.home.createLabel">Create new Pham Vi</Translate>
          </Link>
        </h2>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('begin')}>
                  <Translate contentKey="gatewayApp.donviphathanhPhamVi.begin">Begin</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('end')}>
                  <Translate contentKey="gatewayApp.donviphathanhPhamVi.end">End</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
