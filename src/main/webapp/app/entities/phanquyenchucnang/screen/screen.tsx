...
export interface IScreenProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}

export type IScreenState = IPaginationBaseState;
...
export class Screen extends React.Component<IScreenProps, IScreenState> {
  ...
  render() {
    const { screenList, match, totalItems } = this.props;
    return (
      <div>
        <h2 id="screen-heading">
          <Translate contentKey="gatewayApp.phanquyenchucnangScreen.home.title">Screens</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="gatewayApp.phanquyenchucnangScreen.home.createLabel">Create new Screen</Translate>
          </Link>
        </h2>
                ...
                <tr key={`entity-${i}`}>
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button tag={Link} to={`${match.url}/${screen.id}/edit`} color="primary" size="sm">
                        <FontAwesomeIcon icon="pencil-alt" />{' '}
                        <span className="d-none d-md-inline">
                          <Translate contentKey="entity.action.edit">Edit</Translate>
                        </span>
                      </Button>
                      <Button tag={Link} to={`${match.url}/${screen.id}/delete`} color="danger" size="sm">
