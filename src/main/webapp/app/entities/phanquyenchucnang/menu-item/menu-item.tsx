...
export type IMenuItemState = IPaginationBaseState;
...
export class MenuItem extends React.Component<IMenuItemProps, IMenuItemState> {
  ...
  render() {
    const { menuItemList, match, totalItems } = this.props;
    return (
      <div>
        <h2 id="menu-item-heading">
          <Translate contentKey="gatewayApp.phanquyenchucnangMenuItem.home.title">Menu Items</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="gatewayApp.phanquyenchucnangMenuItem.home.createLabel">Create new Menu Item</Translate>
          </Link>
        </h2>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('name')}>
                  <Translate contentKey="gatewayApp.phanquyenchucnangMenuItem.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th>
                  <Translate contentKey="gatewayApp.phanquyenchucnangMenuItem.menu">Menu</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
...
const mapStateToProps = ({ menuItem }: IRootState) => ({
  ...
  totalItems: menuItem.totalItems
});
