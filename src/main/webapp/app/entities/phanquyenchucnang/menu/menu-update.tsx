...
export class MenuUpdate extends React.Component<IMenuUpdateProps, IMenuUpdateState> {
  ...
  render() {
    const { menuEntity, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="gatewayApp.phanquyenchucnangMenu.home.createOrEditLabel">
              <Translate contentKey="gatewayApp.phanquyenchucnangMenu.home.createOrEditLabel">Create or edit a Menu</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : menuEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="menuCodeLabel" for="menuCode">
