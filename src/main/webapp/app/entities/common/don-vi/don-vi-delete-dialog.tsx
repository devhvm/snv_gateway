...
import { getEntity, deleteEntity } from './don-vi.reducer';
...
export class DonViDeleteDialog extends React.Component<IDonViDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.donViEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="gatewayApp.commonDonVi.delete.question">
          <Translate contentKey="gatewayApp.commonDonVi.delete.question" interpolate={{ id: donViEntity.id }}>
