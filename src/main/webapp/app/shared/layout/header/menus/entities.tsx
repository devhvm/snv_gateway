...
export const EntitiesMenu = props => (
  ...
  <NavDropdown icon="th-list" name={translate('global.menu.entities.main')} id="entity-menu">
    ...
    <DropdownItem tag={Link} to="/entity/menu">
      <FontAwesomeIcon icon="asterisk" fixedWidth />
      &nbsp;
      <Translate contentKey="global.menu.entities.phanquyenchucnangMenu" />
    </DropdownItem>
    <DropdownItem tag={Link} to="/entity/screen">
      <FontAwesomeIcon icon="asterisk" fixedWidth />
      &nbsp;
      <Translate contentKey="global.menu.entities.phanquyenchucnangScreen" />
    </DropdownItem>
    <DropdownItem tag={Link} to="/entity/acess-deny">
      <FontAwesomeIcon icon="asterisk" fixedWidth />
      &nbsp;
      <Translate contentKey="global.menu.entities.phanquyenchucnangAcessDeny" />
    </DropdownItem>
    <DropdownItem tag={Link} to="/entity/menu-role">
      <FontAwesomeIcon icon="asterisk" fixedWidth />
      &nbsp;
      <Translate contentKey="global.menu.entities.phanquyenchucnangMenuRole" />
    </DropdownItem>
    <DropdownItem tag={Link} to="/entity/menu-item">
      <FontAwesomeIcon icon="asterisk" fixedWidth />
      &nbsp;
      <Translate contentKey="global.menu.entities.phanquyenchucnangMenuItem" />
    </DropdownItem>
    <DropdownItem tag={Link} to="/entity/quy-trinh">
      <FontAwesomeIcon icon="asterisk" fixedWidth />
      &nbsp;
      <Translate contentKey="global.menu.entities.quanlyquytrinhQuyTrinh" />
    </DropdownItem>
    <DropdownItem tag={Link} to="/entity/tien-trinh">
      <FontAwesomeIcon icon="asterisk" fixedWidth />
      &nbsp;
      <Translate contentKey="global.menu.entities.quanlyquytrinhTienTrinh" />
    </DropdownItem>
    <DropdownItem tag={Link} to="/entity/tien-trinh-xu-ly">
      <FontAwesomeIcon icon="asterisk" fixedWidth />
      &nbsp;
      <Translate contentKey="global.menu.entities.quanlyquytrinhTienTrinhXuLy" />
    </DropdownItem>
    <DropdownItem tag={Link} to="/entity/co-quan-hanh-chinh">
      <FontAwesomeIcon icon="asterisk" fixedWidth />
      &nbsp;
      <Translate contentKey="global.menu.entities.quytrinhdonviCoQuanHanhChinh" />
    </DropdownItem>
    <DropdownItem tag={Link} to="/entity/quy-trinh-don-vi">
      <FontAwesomeIcon icon="asterisk" fixedWidth />
      &nbsp;
      <Translate contentKey="global.menu.entities.quytrinhdonviQuyTrinhDonVi" />
    </DropdownItem>
    <DropdownItem tag={Link} to="/entity/uy-quyen-du-lieu">
      <FontAwesomeIcon icon="asterisk" fixedWidth />
      &nbsp;
      <Translate contentKey="global.menu.entities.quytrinhdonviUyQuyenDuLieu" />
    </DropdownItem>
    <DropdownItem tag={Link} to="/entity/du-lieu-tien-trinh">
      <FontAwesomeIcon icon="asterisk" fixedWidth />
      &nbsp;
      <Translate contentKey="global.menu.entities.quytrinhdonviDuLieuTienTrinh" />
    </DropdownItem>
    <DropdownItem tag={Link} to="/entity/uy-quyen-tien-trinh">
      <FontAwesomeIcon icon="asterisk" fixedWidth />
      &nbsp;
      <Translate contentKey="global.menu.entities.quytrinhdonviUyQuyenTienTrinh" />
    </DropdownItem>
